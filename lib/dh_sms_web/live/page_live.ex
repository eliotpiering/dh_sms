defmodule DhSmsWeb.PageLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, conversations: all_conversations, current_conversation: nil)}
  end
  ...
  def formatted_last_read_date(conversation) do
    {:ok, date} = conversation.last_read_datetime |> DateTime.shift_zone("America/Chicago")
